...
void printAngleAndDistance(float i)
{
    myServo.write(i);
    wait_ms(30);
    ...
    wait_ms(0.1);
    pc.printf("%f",i); // Sends the current degree into the Serial Port
...
int main()
{
    pc.printf("//// SPIDERSENSE STARTING \\\\\\n");
